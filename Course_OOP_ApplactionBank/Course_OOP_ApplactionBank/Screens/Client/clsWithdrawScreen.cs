...
namespace Course__OOP_Level_2_Applaction
{
    internal class clsWithdrawScreen:clsScreen
    {
        ...
        {
            _DrawScreenHeader("TO Do Withdraw a Client");
            int count = 0;
            ...
            while (count < 3)
            {
                ...
                if (clsBankClient.IsClientExist(_AccountNumber))
                {
                    ...
                    Console.Write("\n ---------    You Need To Withdraw this Client choose Y - N ,Or any char? ");
                    ...
                    if (_char == 'Y' || _char == 'y')
                    {
                        ...
                        if (client.Withdraw(Amount))
                        {
                            ...
                            Console.WriteLine(clsUtil.Tabs(6) + "\n Succesfuly For Withdraw");
                            Console.WriteLine(clsUtil.Tabs(6) + "\n Account Balance is:" + client.AccountBalance);
                        }
                        else Console.WriteLine("\t Not,Succesfuly For Withdraw The Amount Greter Thin Account Balance "+ client.AccountBalance);
