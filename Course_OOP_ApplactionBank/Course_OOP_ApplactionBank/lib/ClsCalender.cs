...
{
    internal class ClsCalender
    {
        public ClsCalender(short Day, short Month, short Year)
        {
            _structDate date;
            date.Day = Day;
           date.Month = Month;
  ...
  public static _structDate ReadFullDate()
        {
            _structDate Date = new _structDate();
            Date.Day = ReadDay();
       ...
       public static void Swapdates(ref _structDate date1, ref _structDate date2)
        {
      ...
      static  bool IsleadYeare(short Year)
        {
     ...
     public static bool IsDate1LessThanData2(_structDate date1, _structDate date2)
        {
        ...
        public static bool IsDate1GreaterThanData2(_structDate date1, _structDate date2)
        {
            return (!IsDate1LessThanData2(date1, date2) && !IsDate1quailData2(date1, date2));
        }
        public static bool IsDate1quailData2(_structDate date1, _structDate date2)
        {
      ...
      static  short NumberOfDayInMonth(short Month, short Year)
       ...
       static  public bool IsValideDate(_structDate date)
        {
      ...
      /* public  string DataToStringd()
        {
          
            return DataToString(this);

        }*/
        public static  string DataToString(_structDate date)
        {
